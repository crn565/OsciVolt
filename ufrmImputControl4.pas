...
const
  ...
  DEST     = 1; //Destination  1= Recorder Control
...
begin
 ...
 //   for C := 0 to AM.Destinations[aDestination].Connections.Count - 2 do
...
procedure TfrmInputControl.Button1Click(Sender: TObject);
...
begin
 ...
 // showmessage(inttostr(myDev));

    salida:=FMixer.GetPeak(DEST,myDev,L,R);
    if salida=true then
    begin
        showmessage('true');
end
