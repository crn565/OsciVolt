...
type
  ...
  public
    ...
    XReal,XImag:TNVector; {initialize before calling}
    Timedata:TNVector;
    TimeDataPtr:TNVectorPtr;
    amps,freqs:TNVector;
    YOffset:integer;
    Image1: TMyImage;
...
begin
  ...
  //image2.visible:=false; {hide the prototype image - used only for visual design}
  image2.free;
...
begin
  ...
  RealFFT(NbrPoints, False, XRealPtr, XImagPtr, Error);
