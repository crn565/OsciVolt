...
begin
  ...
  if MD <> nil then
 // LeftPeak := 1;
  //RightPeak := 1;      //ok    es decir Md<>nill
  ...
  begin
    ...
    begin
      ...
      Cntrls := MD.Controls;
       //LeftPeak := 2;
  //RightPeak := 2;      //por qaquin mook

    end
    else
   //  LeftPeak := 3;
 // RightPeak := 3;      //ok   es decir aconnection <>-1
    ...
    begin
      ...
      begin
        ...
        Cntrls := MC.Controls;
        // LeftPeak := 4;
        //RightPeak := 4;      //ok     es decir mc<>nill
    ...
    // LeftPeak := Cntrls.Count;  //=1
  //RightPeak := SizeOf(TMIXERCONTROL);      //=148 ok
    ...
    begin
      cbStruct := SizeOf(TMIXERCONTROLDETAILS);
       // LeftPeak :=SizeOf(TMIXERCONTROLDETAILS);  //no
    ...
    begin
      ...
      Result := True;
       ...
       LeftPeak :=914; //no pasa
    FreeMem(pmcMixerControlPeak);
   end;
  //LeftPeak:=225;        //no pasa
end;
